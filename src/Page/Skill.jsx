...
const Skill = () => {
  const skills = [
    ...
    { name: "Material UI", img: "https://i.ibb.co.com/VYB3HBRz/material-ui-removebg-preview.png" },
  ...
  return (
    <section className="relative  flex flex-col justify-center container mx-auto items-center overflow-hidden lg:py-16 md:py-8 lg:px-10 md:px-6  py-10 px-10">
      ...
      {/* Title */}
      <h2 className="text-2xl md:text-3xl font-extrabold md:mb-12 mb-8 text-center text-[#9333EA] border-b-3 border-b-[#9333EA]">
        My Tech<span className="text-black"> Stack</span>
      </h2>
